...
class DrawGUI extends Frame
{
     ...
     * 
     */
    private static final long serialVersionUID = -538491318163599700L;
    Draw_awt app; // A reference to the application, to send commands to.
    Color color;
    ...
    */
    public DrawGUI(Draw_awt application)
    {
        super("Draw_awt"); // Create the window
